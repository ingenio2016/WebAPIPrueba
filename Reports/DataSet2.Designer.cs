...
namespace WebAPIPrueba.Reports {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row FindByCompanyIdLinkIdExpr1(int CompanyId, int LinkId, int Expr1) {
            ...
            private void InitClass() {
                ...
                this.columnAsociacion.MaxLength = 2147483647;
...
namespace WebAPIPrueba.Reports.DataSet2TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Companies.CompanyId, Companies.Name, Companies.Phone, Companies.Address, Companies.Logo, Companies.CountryId, Companies.DepartmentId, Companies.CityId, Links.LinkId, Links.UserName, 
                         Links.FirstName, Links.LastName, Links.[Document], Links.Phone AS Telefono, Links.Address AS Expr3, Links.Photo, Links.CountryId AS Expr4, Links.DepartmentId AS Expr5, Links.CityId AS Expr6, 
                         Links.CompanyId AS Expr7, Links.BossId, Links.CommuneId, Links.WorkPlace, Links.Date, Links.VotingPlaceId, Links.Barrio, Links.DateBorn, Links.Profesion, Links.Especialidad, Links.TiempoExperiencia, 
                         Links.Asociacion, VotingPlaces.VotingPlaceId AS Expr1, VotingPlaces.Name AS VotingName
FROM            Companies INNER JOIN
                         Links ON Companies.CompanyId = Links.CompanyId INNER JOIN
                         VotingPlaces ON Links.VotingPlaceId = VotingPlaces.VotingPlaceId";
