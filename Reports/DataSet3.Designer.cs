...
namespace WebAPIPrueba.Reports {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row FindByCompanyIdCoordinatorIdExpr1ReferId(int CompanyId, int CoordinatorId, int Expr1, int ReferId) {
            ...
            private void InitClass() {
                ...
                this.columnCoordinatorId.AutoIncrement = true;
                this.columnCoordinatorId.AutoIncrementSeed = -1;
                this.columnCoordinatorId.AutoIncrementStep = -1;
                this.columnCoordinatorId.AllowDBNull = false;
                this.columnCoordinatorId.ReadOnly = true;
...
namespace WebAPIPrueba.Reports.DataSet3TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Companies.CompanyId, Companies.Name, Companies.Phone, Companies.Address, Companies.Logo, Companies.CountryId, Companies.DepartmentId, Companies.CityId, Coordinators.CoordinatorId, Coordinators.UserName, 
                         Coordinators.FirstName, Coordinators.LastName, Coordinators.[Document], Coordinators.Phone AS Telefono, Coordinators.Address AS Expr3, Coordinators.Photo, Coordinators.CountryId AS Expr4, 
                         Coordinators.DepartmentId AS Expr5, Coordinators.CityId AS Expr6, Coordinators.CompanyId AS Expr7, Coordinators.LinkId, Coordinators.CommuneId, Coordinators.userId AS Expr2, Coordinators.BossId, Coordinators.Date, Coordinators.VotingPlaceId, Coordinators.ReferId AS Expr8, Coordinators.Barrio, Coordinators.DateBorn, Coordinators.Profesion, Coordinators.Associacion, 
                         Coordinators.Especialidad, Coordinators.TiempoExperiencia, VotingPlaces.VotingPlaceId AS Expr1, VotingPlaces.Name AS VotingName, Refers.FullName AS referido, Refers.ReferId
FROM            Companies INNER JOIN
                         Coordinators ON Companies.CompanyId = Coordinators.CompanyId INNER JOIN
                         VotingPlaces ON Coordinators.VotingPlaceId = VotingPlaces.VotingPlaceId INNER JOIN
                         Refers ON Coordinators.ReferId = Refers.ReferId";
