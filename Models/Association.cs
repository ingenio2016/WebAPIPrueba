...
namespace WebAPIPrueba.Models
{
    public class Association
    {
        ...
        [Index("Association_Name_Index", 4, IsUnique = true)]
        ...
        [Index("Association_Name_Index", 3, IsUnique = true)]
        public int CityId { get; set; }

        [Required(ErrorMessage = "El campo {0} es requerido")]
        [Range(1, double.MaxValue, ErrorMessage = "Debe seleccionar {0}")]
        [Display(Name = "Departamento")]
        [Index("Association_Name_Index", 2, IsUnique = true)]
        public int DepartmentId { get; set; }

        [Required(ErrorMessage = "El campo {0} es requerido")]
        [Range(1, double.MaxValue, ErrorMessage = "Debe seleccionar {0}")]
        [Display(Name = "País")]
        [Index("Association_Name_Index", 1, IsUnique = true)]
